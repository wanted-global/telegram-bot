<?php
ob_start();
define('API_KEY','1479703875:AAE_Ngt08eY_ZFD6C1TWN6MwWmYkxgSxyx4');
...
$Dev = array("1091790275","1638536605","3");
$usernamebot = "WantedGlobalBoT";
$channel = "Wanted_Global";
$admin = 1091790275;
$channelcode = "1365686908";
$token = API_KEY;
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
[اضغط هنا وتابع جديدنا ، 📢](https://t.me/wanted_global)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
   ...
   [
   ['text'=>"- مشاركة الرابط ، 📧 '",'callback_data'=>'member'],['text'=>"- تحويل نقاط ، ♻️ '",'callback_data'=>'sendcoin']
   ],
      [
   ['text'=>"- ارسال اقتراح ، 🇮🇶 '",'callback_data'=>'sup']
   ],
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"- القناة الرئيسية للبوت اذا كنت غير مشترك عند اشتراكك سوف تحصل على 2 من النقاط ، 💬 '
...
• هذه الفرصة لا تتكرر ، بعد الاشتراك اضغط على التالي ، ♥️👇🏿؛",
			   ...
			   iiiiZ('sendmessage',[
	'chat_id'=>$admin,
	'text'=>"- هذا اشترك بالقناة الرئيسية للبوت ،
	- [$firstname](tg://user?id=$fromid)  ",
	'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
	]);
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"- انتهت القنوات المضافة ؛ يرجى المحاولة مرة اخرى في تجميع النقاط ، او قم بمشاركة الرابط بدل عن الاشتراك في القنوات ، 📻 ' !",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
...
if($okchannel != 'member' && $okchannel != 'creator' && $okchannel != 'administrator'){
        iiiiZ('answercallbackquery', [
            'callback_query_id' =>$membercall,
            'text' => "• قم بالاشتراك في القناة اولا ؛ ثم اضغط على التالي ، 🔱 !",
            'show_alert' =>true
        ]);
        iiiiZ('sendmessage',[
	'chat_id'=>$admin,
	'text'=>"- هذا لم يشترك ويضغط اشتركت ،
	- [$firstname](tg://user?id=$fromid)  ",
	'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
	]);
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"- انتهت القنوات المضافة ؛ يرجى المحاولة مرى اخرة في تجميع النقاط ، او قم بمشاركة الرابط بدل عن الاشتراك في القنوات ، 📻 ' !",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
				   ['text'=>"- تحديث ، 📑 '",'callback_data'=>'takecoin'],['text'=>"• العودة ، 🔙 '",'callback_data'=>'panel']
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"• جميع احصائيات النقاط الخاصة بك ؛ 💛👇🏿 ' 
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
	'text'=>"- لستة القنوات التي قمت بالاشتراك فيها ، 💛👇🏿؛
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
	'text'=>"- لستة القنوات التي قمت بتمويلها ؛ 🌼👇🏿 '
...
- يمكنك جمع النقاط وزيادة اعضاء قناتك اعضاء حقيقيين من خلال البوت باليوم 500 عضو واكثر وكل شيء مضمون ، 📻 !

- قم بالدخول الى البوت من خلال الرابط التالي لا تقم بتفويت هذه الفرصة العظيمة ، 👇🏿♥️ ؛
https://t.me/$usernamebot?start=$fromid",
    		]);
	iiiiZ('sendmessage',[
	'chat_id'=>$chatid,
	'text'=>"- قم بمشاركة الرابط الذي في الاعلى واحصل على النقاط بكل سهولة ؛ دون الاشتراك في القنوات قم بارسال رابطك الى جميع المجموعات والقنوات واحصل على النقاط ، 🐬 !

• عدد النقاط الخاصة بك ؛ $coin
• عدد الذين قاموا بالدخول الى رابطك ؛ $invite",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
['text'=>"• العودة ، 🔙 '",'callback_data'=>'panel']
...
- المعلومات العامة للعضو والنقاط ، 📌 ؛
...
- معلومات العضو الذي قام بإرسال النقاط اليك ، 🔱 ؛
...
else
{
	iiiiZ('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"- عدد النقاط الذي تود ارساله اقل من عدد نقاطك ، 🐬 !
...
iiiiZ('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"- الان قم بإرسال معرف القناة ؛ 🎲 !
- مثال ؛ @$channel 
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
...
$maxmember = floor($max);
         iiiiZ('sendmessage',[
        	'chat_id'=>$chat_id,
        	'text'=>"• تم حفظ القناة الخاصة بك ، ☑️ '
- القناة الخاصة بك ؛ $textmassage
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎

- عدد الاعضاء الذي يمكنك طلبهم للقاة ؛ $coin .

• الان قم بإرسال العدد المطلوب من الاعضاء لقناتك مثل 50 ؛ علماً ان العضو الواحد ب2 من العملات ، 🏹 '",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
['text'=>"• العودة ، 🔙 '",'callback_data'=>'panel']
...
iiiiZ('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"- اهلا بك عزيزي المطور بندر '
- قم باختيار ماتريد من القائمة التي في الاسفل ، 👅 '
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
...
◾️ عدد الاعضاء ؛ $all ،
▫️ عدد القنوات بقائمة التمويل ؛ $order .
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
                'hide_keyboard'=>true,
		]);
		}
...
◾️ عدد القنوات التي تحت التمويل ؛ $ordercount
		▫️ لستة معرفات القنوات التي تحت التمويل ؛ 📌
$result",
                'hide_keyboard'=>true,
		]);
		}
...
if (in_array($from_id,$Dev)){
				iiiiZ('sendmessage',[
		'chat_id'=>$chat_id,
		'text'=>"ارسل ايدي العضو الذي تريد الإرسال اليه او ارسل توجيه من العضو",
  'reply_markup'=>json_encode([
    'keyboard'=>[
	[
	['text'=>"• العودة ، 🔙 '"] 
...
else
{
	         iiiiZ('sendmessage',[
        	'chat_id'=>$chat_id,
        	'text'=>"ارسل العدد الذي تريد ارساله الى صاحب الايدي : $textmassage",
	  'reply_to_message_id'=>$message_id,
	   'reply_markup'=>json_encode([
    'keyboard'=>[
	[
...
elseif($update->message->text != true){ 
	iiiiZ('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"• يرجى استخدام ازرار البوت فقط ارسل /start لرؤية الازرار ، للاستفسار او لشراء النقاط عليك مراسلة المبرمج ؛ @$username ، 💌 !",
	  	]);
}
unlink("error_log");
?>